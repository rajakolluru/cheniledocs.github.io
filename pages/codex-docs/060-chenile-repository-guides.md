...
- Services can declare `serviceModule` and resolve their service version from a named `xxx.version` entry rather than only from the default service id mapping.
